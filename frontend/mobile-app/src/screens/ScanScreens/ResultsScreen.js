...
const QualityMetricsChart = ({ metrics }) => {
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.sectionTitle}>
        <Ionicons name="stats-chart" size={18} color={theme.colors.primary} /> Quality Metrics
      </Text>
...
const FlowerQualityCard = ({ quality }) => {
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.sectionTitle}>
        <Ionicons name="flower" size={18} color={theme.colors.primary} /> Flower Quality
      </Text>
...
const ObservationsCard = ({ observations }) => {
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.sectionTitle}>
        <Ionicons name="eye" size={18} color={theme.colors.primary} /> AI Observations
      </Text>
            ...
            {hasGeminiData && !isNotFlower && (
              <>
                ...
                {geminiData.reasoning && (
                  <View style={styles.card}>
                    <Text style={styles.sectionTitle}>
                      <Ionicons name="chatbubble-ellipses" size={18} color={theme.colors.primary} /> AI Reasoning
                    </Text>
