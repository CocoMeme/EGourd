...
/**
 * Final Verdict Card — side-by-side TM vs Gemini with agree/disagree badge + circular progress rings
 */
const FinalVerdictCard = ({ tmPrediction, geminiPrediction, comparisonResult, isGeminiLoading }) => {
