...
## Vision
To revolutionize gourd farming and research by providing an AI-driven ecosystem that simplifies species identification, accurate harvest prediction, and data-driven community management.

## Target Audience
- **Farmers & Gardeners:** Utilizing the mobile application for on-the-go identification and harvest insights.
- **Agricultural Researchers:** Leveraging the web dashboard to analyze classification data and trends.
